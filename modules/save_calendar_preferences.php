<?php
// Fichier de sauvegarde des préférences de calendriers Google
...
$_SESSION['selected_calendars'] = $data['calendars'];
...
if (isset($pdo) && $pdo !== null) {
    try {
        ...
        // Mettre à jour les préférences de calendriers
        $preferences['selected_calendars'] = $data['calendars'];
...
echo json_encode(['success' => true, 'message' => 'Préférences de calendriers sauvegardées']);
?>